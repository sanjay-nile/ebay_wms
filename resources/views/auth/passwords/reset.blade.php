                ...
                <div class="col-md-4 register-left">
                    <div class="banner-content">
                        ...
                        @if(Auth::guest())
                            ...
                            @if(Request::is('register') || Request::is('password/reset/*') || Request::is('password/reset'))
                                @if(Request::get('client'))
                                    <a href="{{ route('home.page.user', Request::get('client')) }}" class="btn btn-sm btn-warning btn-login-lf" id="login-form-link">
                    ...
                    <div class="col-md-8 register-right">                        
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                                <h3 class="register-heading">{{ __('Set Your Password') }}</h3>
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-8">
                                        <form method="POST" action="{{ route('password.update') }}">
                                            ...
                                            <input type="hidden" name="client_user" value="{{ Request::get('client') }}">
