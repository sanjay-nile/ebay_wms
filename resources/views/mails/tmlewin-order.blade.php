        	...
        	<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family: Arial, Helvetica, sans-serif;padding:10px;" width="100%">
				 ...
				 <td>
				    <table width="100%" border="0" align="center"  cellpadding="0" cellspacing="0" style="padding: 10px;">
				       <tr>
				          <td align="center">
				             <a href="#">
				                <img src="{{ asset('public/images/TM-Lewin-Black.png') }}" border="0" alt="" style="display: block; height:60px;"/>
				             </a>
				          </td>
				       </tr>
				    </table>
			           ...
			           <tr>
			              ...
			              <td style="width: 33%; padding: 10px; vertical-align: top;" align="center">
			                 <table border="0" align="center" cellpadding="0" cellspacing="0">
			                    ...
			                    <tr>
			                       <td align="center" style="color: #000000; font-size: 13px;font-weight: 500; line-height: 20px;">
			                             We’ll keep you updated on your return. You can also <a style="color: #000;" target="_blank" href="{{ route('tmlewin.tracking') }}"><b><u>track your return</u></b></a> to see where it’s up to.
			                       </td>
			                    </tr>
			                 </table>
			              </td>
			  ...
			  <tr>
			     <td align="center" style="color: #000000; font-size: 14px;font-weight:700; line-height: 35px;" >
			           Got a question? Visit our  <a target="_blank" href="{{ route('tmlewin.help') }}" style="text-decoration: none;"> <span style="color: #e3b3b7;">help page</span></a>
			     </td>
			  </tr>
			  <tr>
