			           ...
			           <tr>
			              ...
			              <td style="width: 33%; padding: 10px; vertical-align: top;" align="center">
			                 <table border="0" align="center" cellpadding="0" cellspacing="0">
			                    ...
			                    <tr>
			                       <td align="center" style="color: #000000; font-size: 13px;font-weight: 500; line-height: 20px;">
			                             We’ll keep you updated on your return. You can also <a style="color: #000;" target="_blank" href="{{ route('missguided.tracking') }}"><b><u>track your return</u></b></a> to see where it’s up to.
			                       </td>
			                    </tr>
			                 </table>
			              </td>
