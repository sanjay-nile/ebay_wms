    ...
    <body>
        <div class="" style="background-color:#eff4f9; width: 640px; border: 1px solid #ccc; margin: auto;  ">
                    ...
                    <tr>
                        <td style=" padding: 16px 0 16px 16px;" valign="top">
                            <table align="left" bgcolor="#FFF" border="0" cellpadding="0" cellspacing="0" width="50%">
                                <tr>
                                    <td>
                                        <img alt="" border="0" src="{{ asset('public/images/mainlogo.png') }}" style="margin:0; padding:0; display:block;" width="120px"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <table class="wrapper welcome-scr">
                <tr>
                    <td colspan="4">
                        <img src="{{ asset('public/images/reversegear-screen.jpg') }}" style="width: 100%">
                        </img>
                    </td>
                    <tr>
                    ...
                    <tr>
                        <td align="center" colspan="4">
                            <a href="{{ url('password/reset', $token).'?email='.urlencode($user->email).'&client='.$client_user }}" style="color: #fff; background: #43c16f; border-radius: 40px; padding: 13px 52px; border:none; margin-bottom: 25px; display: inline-block;">
                                Reset Your Password
                            </a>
                        </td>
                    </tr>
            ...
            <table align="center" bgcolor="#43c16f" border="0" cellpadding="4" cellspacing="0" width="100%">
                <tr>
                    <td valign="top">
