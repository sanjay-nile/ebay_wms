                ...
                <tr>
                    ...
                    <tr>
                        <td colspan="4" style="padding: 16px;">
                            ...
                            <p>
                                Thanks for joining Reverse Gear. Reverse Gear supports global businesses to efficiently manage, track and save money on returned items wherever they operate in the world. Click below button to login your account.
                            </p>
                            <p><h5>Login Detail:</h5></p>
                            <p>E-mail : {{ $user->email }}</p>                            
                            <p>Set up your account to get started! Please click on Set Password button</p>
                            <p>
