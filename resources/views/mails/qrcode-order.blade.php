			           ...
			           <tr>
			              <td style="width: 33%;padding: 10px; vertical-align: top;" align="center">
			                 <table border="0"  align="center" cellpadding="0" cellspacing="0">
			                    <tr>
			                       <td align="center" style="height: : 33%">
			                          {{-- <a target="_blank" href="{{ $user['url'] }}"> --}}
			                          	<img src="{{ asset('label/QR_CODE.jpg') }}" style="border:none;outline: none; height: 100px" border="0" alt="">
			                          {{-- </a> --}}
			                       </td>
			                    </tr>
			                    ...
			                    <tr>
                                   ...
                                   Scan the QR Code at your local Drop-off location to print out your returns label.
			                       </td>
			                    </tr>
			                 </table>
			              </td>
			              <td style="width: 33%;padding: 10px;  vertical-align: top;" align="center">
			                 <table border="0" align="center" cellpadding="0" cellspacing="0">
			                    ...
			                    <tr>
			                       <td align="center" style="color: #000000; font-size: 13px;font-weight: 500; line-height: 20px; ">
                                   Find your local Drop-off location  <a style="color: #000;" target="_blank" href="{{$user['emailurl']}}"><b><u>here</u></b></a>
			                       </td>
			                    </tr>
			                 </table>
			              </td>
