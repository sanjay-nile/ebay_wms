                ...
                <tr>
                    ...
                    <tr>
                        <td colspan="4" style="padding: 16px;">
                            ...
                            <p>
                                Thanks for joining Reverse Gear. Reverse Gear supports global businesses to efficiently manage, track and save money on returned items wherever they operate in the world. Click below button to activate your account.
                            </p>
                            <p>
                    ...
                    <tr>
                        <td align="center" colspan="4">
                            @if(isset($client_user) && !empty($client_user))
                                <a href="{{ route('activate', [$user->token]) }}/?client={{ $client_user }}" style="color: #fff; background: #b51f38; border-radius: 40px; padding: 13px 52px; border:none; margin-bottom: 25px; display: inline-block;">
                                    Activate
                                </a>
                            @else
                                <a href="{{ route('activate', [$user->token]) }}" style="color: #fff; background: #b51f38; border-radius: 40px; padding: 13px 52px; border:none; margin-bottom: 25px; display: inline-block;">
                                    Activate
                                </a>
                            @endif                            
                        </td>
