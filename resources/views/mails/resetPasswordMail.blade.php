                    ...
                    <tr>
                        <td align="center" colspan="4">
                            @if(isset($client_user) && !empty($client_user))
                                <a href="{{ route('home.page.user', $client_user) }}" style="color: #fff; background: #b51f38; border-radius: 40px; padding: 13px 52px; border:none; margin-bottom: 25px; display: inline-block;">
                                    Login your account
                                </a>
                            @else
