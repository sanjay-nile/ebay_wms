                            ...
                            <form class="form-horizontal fiter-form ml-2 mt-1 align-col">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mt-1">
                                        ...
                                        <a href="{{ route('admin.cust.broker') }}" class="btn-refresh reset"><i class="la la-refresh"></i> Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="card-table-4">
                                    ...
                                    <div class="list-table">
                                        ...
                                        <div class="list-1 pull-right">
                                            <a class="btn view-btn-ic" href="{{ route('admin.cust.broker.show',$row) }}" title="View">
                                                View
                                            </a>
                                        </div>
                                        <div class="list-1 pull-right mb-2">
                                            <a class="btn edit-btn-ic" href="{{ route('admin.cust.broker.edit',$row) }}" title="Edit">
                                                Edit
                                            </a>
                                        </div>
                                    </div>
