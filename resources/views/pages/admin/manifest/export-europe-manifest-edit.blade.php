...
<script>
    $(document).ready(function(){        
        ...
        $('input[name="import_entry_date"]').datepicker({autoclose: true,todayHighlight: true,format: "yyyy/mm/dd"});
    ...
    <div class="app-content content">
        <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-md-8 align-self-left">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Export Out of Europe</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('admin.generate.manifest') }}" method="post" id="product-form" class="form-horizontal fiter-form mb-0">
                ...
                <input type="hidden" name="manifest_type" id="manifest_type" value="export_europe">
            </form>
        </div><!-- /.content-wrapper -->
                ...
                <div class="col-xs-12 col-md-12">
                    ...
                    <div class="card booking-info-box">
                        <div class="card-content">
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.export.europe.update') }}" autocomplete="off">
                                    @csrf
                                    <input type="hidden" name="p_id" value="{{ $pallet->id }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="card-title">
                                                <a href="{{ route('admin.export.europe') }}" class="btn btn-outline-primary btn-sm"><i class="la la-arrow-left"></i> Back</a>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Billing Currency</label>
                                                <input type="text" class="form-control" name="billing_currency" value="{{ $pallet->meta->billing_currency ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Import Entry Number</label>
                                                <input type="text" class="form-control" name="import_entry_number" value="{{ $pallet->meta->import_entry_number ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Import Entry Date</label>
                                                <input type="text" class="form-control" name="import_entry_date" value="{{ $pallet->meta->import_entry_date ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">VAT Paid</label>
                                                <input type="text" class="form-control" name="vat_paid" value="{{ $pallet->meta->vat_paid ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Duty Paid</label>
                                                <input type="text" class="form-control" name="duty_paid" value="{{ $pallet->meta->duty_paid ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
