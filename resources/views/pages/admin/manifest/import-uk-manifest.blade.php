                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-3">
                                             <div class="form-group">
                                                <select name="ship_type" id="" class="form-control">
                                                    <option value="" selected="">Select Pallet</option>
                                        ...
                                        {{-- <div class="col-md-3">
                                            <div class="input-group">
                                                <input type="text" name="start" class="form-control" placeholder="From Date" value="" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <input type="text" name="end" class="form-control" placeholder="To Date" value="" autocomplete="off">
                                            </div>
                                        </div> --}}                                    
                                        <div class="col-md-3 mt-1">
                                            <button type="submit" class="btn btn-cyan" id="search-btn"><i class="la la-search"></i> Search</button>
                                            <a href="{{ route('admin.pallet.list') }}" class="btn-refresh reset"><i class="la la-refresh"></i> Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="card-table-4">
                                        ...
                                        <div class="list-table">
                                            ...
                                            <div class="list-1 pull-right">
                                                <a class="btn view-btn-ic" href="{{ route('admin.import.uk.show',$row) }}" title="View">
                                                    View
                                                </a>
                                            </div>
                                            <div class="list-1 pull-right mb-2">
                                                <a class="btn edit-btn-ic" href="{{ route('admin.import.uk.edit',$row) }}" title="Edit">
                                                    Edit
                                                </a>
                                            </div>
                                        </div>
