            ...
            <div class="row">
                <div class="col-md-12 align-self-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Operator Rep</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-md-12 table-responsive">
                <div class="card booking-info-box">
                    <div class="card-header">
                        <h4 class="card-title">
                            <a href="{{ route('admin.operator') }}" class="btn btn-outline-primary btn-sm"><i class="la la-arrow-left"></i> Back</a>
                        </h4>
                                ...
                                <div class="list-your-service-content">
                                    <div class="container">
                                        <div class="list-your-service-form-box" style="width: 85%;">
                                            <div class="row">
                                                <div class="col-md-12"><h5 class="card-title">Edit Operator Rep </h5></div>
                                            </div>
                                            <form action="{{ route('admin.operator.update',$user) }}" method="post">
                                                @csrf
                                                {{ method_field('put') }}
                                                <div class="row">
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="department" placeholder="Enter Your Department" value="{{ $user->department ?? '' }}">
