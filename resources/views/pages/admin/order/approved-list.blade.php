...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.reason-slt').select2({
                placeholder: 'Select Reason of Return',
                allowClear: true
            });
        })
    </script>
    ...
    <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-8 align-self-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">eBay Approved List</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="col-md-12">
                                <form action="" method="get" class="form-horizontal" autocomplete="off" id="filter-frm">
                                    <div class="form-row align-items-center">
                                        ...
                                        <div class="form-group col-md-3">
                                            <select name="return_reason[]" class="form-control select2 reason-slt" id="myselect" multiple>
                                        ...
                                        <div class="form-group col-md-3">
                                            <select name="condition" class="form-control">
                                                ...
                                                @forelse(conditions() as $k => $v)
                                                    <option value="{{ $k }}" {{ (request('condition') == $k) ? 'selected' : '' }}>{{ $k }}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <a href="{{ route('admin.approved.item') }}" class="btn btn-Reset">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Approved Lists</h5>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered table-hover admin-data-table admin-data-list table-sm">
                                    <thead>
                                        <tr> 
                                            ...
                                            <th class="ws">Customer Comment</th>
