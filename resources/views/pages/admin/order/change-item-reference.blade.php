                ...
                <div class="row">
                    <div class="col-md-8 align-self-left">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Item Layout</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="info-list-section">
                                    <form method="post" action="{{ route('admin.item.ref.store') }}" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Item Ref. File</label>
