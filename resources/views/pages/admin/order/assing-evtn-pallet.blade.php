			...
			<div class="row">
				<div class="col-md-8 align-self-left">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Assign EVTN To Pallet</li>
					</ol>
				</div>
			</div>
		</div>
                        ...
                        <section class="list-your-service-section">
                            <div class="list-your-service-content">
                                <div class="list-your-service-form-box">
                                    <div class="row">
                                        <div class="col-md-12"><h5 class="card-title">Assign EVTN To Pallet</h5></div>
                                    </div>
                                   <form method="post" action="{{ route('admin.assign.pallet.orders') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
