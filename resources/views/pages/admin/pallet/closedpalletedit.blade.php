...
<script type="text/javascript">
    $(document).ready(function(){
        $('input[name="pallet_date"]').datepicker({autoclose: true,todayHighlight: true,format: "yyyy/mm/dd", orientation: "bottom left"});
    });
</script>
@endpush
                    ...
                    <div class="box-header">
                        ...
                        <h4 class="card-title">
                            ...
                            @if($pallet->pallet_type == 'Closed')
                                ...
                                {{-- <a href="{{ route('admin.download.ebay.image', $pallet->pallet_id) }}" class="btn btn-success btn-sm">
                                    <i class="la la-arrow-up"></i> Download Imagess
                                </a> --}}
                            @endif
                        </h4>
                    </div>
