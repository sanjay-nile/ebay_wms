                                ...
                                <form action="" method="get" class="form-horizontal" autocomplete="off" id="frm-sbmit">
                                    <div class="form-row align-items-center">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <a href="{{ route('admin.shipped.pallet.list') }}" class="btn btn-Reset">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($lists as $row)
                                        <tr>
                                            ...
                                            <td class="ws">
                                                <a class="btn btn-view" href="{{ route('admin.show.shippedpallet',$row) }}" title="View">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a class="btn btn-edit" href="{{ route('admin.edit.shippedpallet',$row) }}">
