                                    ...
                                    <div class="form-row align-items-center">
                                        ...
                                        <div class="form-group col-md-3">
                                            <select name="sales_incoterm" id="" class="form-control">
                                                <option value="">-- Select Sales Incoterm --</option>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <a href="{{ route('admin.pallet.list') }}" class="btn btn-Reset">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($lists as $row)
                                        <tr>
                                            ...
                                            <td class="ws">{{ $row->sales_incoterm }}</td>
                                            ...
                                            <td class="ws">
                                                ...
                                                <a class="btn btn-edit" href="{{ route('admin.edit.pallet',$row) }}">
