            ...
            <div class="row">
                <div class="col-md-12 align-self-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Admin Rep</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="list-your-service-content">
                                    <div class="container">
                                        <div class="list-your-service-form-box" style="width: 85%;">
                                            <div class="row">
                                                <div class="col-md-12"><h5 class="card-title">Edit Admin Rep </h5></div>
                                            </div>
                                            <form action="{{ route('admin.sub-admin.update',$user) }}" method="post">
                                                @csrf
                                                {{ method_field('put') }}
                                                <div class="row">
                                                    <div class="col-md-6">
