            ...
            <div class="row">
				<div class="col-md-12 align-self-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">View Admin Rep</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($users as $user)
                                    	<tr>
                                            ...
                                            <td>
                                                <a class="btn btn-view btn-primary" href="{{ route('admin.sub-admin.edit', $user) }}" title="Edit"><i class="la la-edit"></i></a>
                                                <a class="btn btn-delete btn-danger" onclick="return confirm('Are you sure to delete this admin?. If you delete this admin then all its assign client will be unassigned.')" href="{{ route('admin.sub-admin.destory', $user->id) }}" title="Delete"><i class="la la-trash"></i></a>
                                            </td>   
                                        </tr>
                                    @empty
                                    @endforelse
