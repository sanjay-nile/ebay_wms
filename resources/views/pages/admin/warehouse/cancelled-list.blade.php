    ...
    <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12 align-self-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Cancelled List</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <div class="card rack-info-box">
                    <div class="card-header">
                        <h5 class="card-title">Cancelled Filters</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="card rack-info-box">
                    <div class="card-header">
                        <h5 class="card-title">Cancelled Lists</h5>
                    </div>
                                ...
                                <tbody>
                                    @forelse($orders as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td class="ws">{{ $reason }}</td>
                                            <td class="ws" style="white-space: nowrap;">{!! date('d-m-Y', strtotime($row->scan_out_date)) !!}</td>
