                                ...
                                <div class="form-group col-md-3">
                                    <select name="client_id" class="form-control">
                                        ...
                                        @forelse($clients as $client)
                                            <option value="{{ $client->id }}" @if($client->id == $single_wh->user_id) selected @endif>{{ $client->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                    @error('client_id')
                                    ...
                                    @if(isset($state_list) && $state_list)
                                        <select class="form-control form-control-sm" name="state_id">
                                            ...
                                            @forelse($state_list as $state)
                                                <option value="{{ $state->shortname }}" name="{{ $state->name }}" {{ ($state->id==$single_wh->state_id)?'selected':'' }} >{{ $state->name }}</option>
                                            @empty
                                            @endforelse
                                         </select>
                                    @else
