          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-sm" placeholder="From OU" name="FromOU" value="{{ $warehouse->FromOU }}">
                </div>
            </div>
          </div>
      </div>
...
<script>
  $("#temp-warehouse").validate({
          ...
          submitHandler: function(form) {
            ...
            let FromOU     = getValueByKey('FromOU',data);
