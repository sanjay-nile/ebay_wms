            ...
            <div class="row">
                <div class="col-md-8 align-self-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Process Return Order Details</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-md-12">
                <div class="card booking-info-box">
                    <div class="card-header">
                        ...
                        @endphp
                        <h4 class="card-title">
                            <a href="{{ route('process.list') }}" class="btn btn-outline-info btn-sm"><i class="la la-arrow-left"></i> Back</a>
                            @if($hrs)
