...
.datepicker table td.disabled, .datepicker table td.disabled:hover {
    background: rgba(232, 232, 228) !important;
    ...
    <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                      <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            @if(Request::is('admin/actual-statistics'))
                                <li class="breadcrumb-item active">30 Days Actual Statistics</li>                                
                            @else
                                <li class="breadcrumb-item active">All Previous Actual Statistics</li>
                            @endif
                        </ol>
                      </div>
                    </div>
                            ...
                            <div class="">
                                <div class="col-md-12">
                                    <ul class="row nav nav-tabs" role="tablist">
                                        ...
                                        <li class="p-0 col-md-6 nav-item tabs-section">
                                            <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">Additional Filters</a>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-md-12 pull-right">
                                                    <div class="" style="margin-bottom: 16px;">
                                                        <button type="submit" class="btn btn-search btn-sm search-btn">
        ...
        <section class="card table-card-section">
            <div class="alert alert-success">
                Showing {{ $lists->firstItem() }} to {{ $lists->lastItem() }} of Total {{ $lists->total() }} Orders</strong> (Last 30 Days)
            </div>
            <div class="row">
                <div class="col-xs-12 col-md-12 ">
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body booking-info-box card-dashboard table-responsive">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    @include('pages.admin.return-orders.html.actual-parcel-order')
                                    @include('pages.admin.return-orders.html.actual-item-order')
                                </div>                    
                            </div>
                        </div>
                    </div>
