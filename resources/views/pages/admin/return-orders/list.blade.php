                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                      <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">View Return Orders List</li>
                        </ol>
                      </div>
                    </div>
                </div>
                                    ...
                                    @forelse($lists as $row)
                                        @forelse($row->packages as $pakage)
                                            <tr>
                                                ...
                                                <td>{!! ($row->meta->_currency)?get_currency_symbol($row->meta->_currency):($row->meta->_rate) ? get_currency_symbol('USD'):'' !!}{{ (is_numeric($row->meta->_rate)) ? $row->meta->_rate : 0}}</td>
