...
$(document).ready(function() {
    $('input[name="start"]').datepicker({autoclose: true,todayHighlight: true,format: "yyyy/mm/dd", orientation: "bottom right"});
    $('input[name="end"]').datepicker({autoclose: true,todayHighlight: true,format: "yyyy/mm/dd", orientation: "bottom right"});
...
<div class="app-content content">
    <div class="content-wrapper">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" name="rg_id" class="form-control" value="{{ app('request')->input('rg_id') }}" autocomplete="off" placeholder="RG Order ID" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input type="text" name="pallet_id" class="form-control" value="{{ app('request')->input('pallet_id') }}" placeholder="Pallet ID" />
                                                    </div>
                                                </div>
                                                <div class="col-md-12 pull-right">
                                                    ...
                                                    <div class="" style="margin-bottom: 16px;">
                                                        ...
                                                        <a href="{{ route('status.update') }}" class="btn cl-orange reset btn-sm">
        ...
        <section class="card table-card-section">
            <div class="row">
                <div class="col-md-12">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.import.status') }}" id="formid">
                        @csrf
                        <div class="rg-pack-card">
                            <h5>Update Order Status Data</h5>
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="file" name="package_file" id="package_file" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
