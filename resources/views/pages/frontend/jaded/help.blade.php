<div class="help-wrapper">
   <!-- <div class="form-search-container">
      ...
      <div class="row">
        @include('pages.frontend.jaded.sidebar')
        <div class="col-md-9">
                         ...
                         <div class="card mb-0">
                            ...
                            <div id="collapse-1" class="card-body collapse" data-parent="#accordion" >
                               <div class="faq-accordion-body">
                                  ...
                                  <p>
                                     After this point, the retailer will process your return and arrange for your refund in accordance with their specific returns policy. <a href="https://jadedldn.com/a/returns" target="_blank" rel="noopener">View our return policy</a>.
                                  </p>
                               </div>
                            </div>
                            ...
                            <div id="collapse-2" class="card-body collapse" data-parent="#accordion" >
                               <div class="faq-accordion-body">
                                  <p>
                                     If you are having trouble registering a return, <a href="https://jadedldn.com/pages/contact-us" target="_blank" rel="noopener">contact us</a> with your order number and screenshots of the error message you are seeing.
                                  </p>
                                  <!--   <p>
                            ...
                            <div id="collapse-7" class="card-body collapse" data-parent="#accordion" >
                               <div class="faq-accordion-body">
                                  <p>
                                     If your return doesn't have any tracking updates within 24 hours of delivering it to your chosen drop off point, please <a href="https://jadedldn.com/pages/contact-us" target="_blank" rel="noopener">contact us</a> providing your order number/ tracking number.
                                  </p>
                               </div>
                            </div>
                         </div>
