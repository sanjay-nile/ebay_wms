						          					...
						          					<div class="row">
							                  			...
							                  			<div class="col-md-12">
							                  				<div class="form-group">
							                  					...
							                  					<input type="text" class="form-control valid-field" name="customer_phone" id="customer_phone" placeholder="{{googleTranslate('Enter Phone Number')}}">
							                  					<span class="text-danger"></span>
							                  				</div>
							                  			</div>
							                  			<div class="col-md-5">
		      					              						...
		      					              						<tr>
		      					              							...
		      					              							<td>
		      					              								<div class="carrier-label-card">
		      					              									...
		      					              									<div class="carrier-label-card-text">24/7 InPost Lockers:<br> Drop off <br> No Printer Required <br> 3-5 Days</div>
		      					              								</div>
		      					              							</td>
		      					              							<td>
		      					              								<p class="">15kg</p>
