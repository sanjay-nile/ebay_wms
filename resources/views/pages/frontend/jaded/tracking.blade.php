				...
				{{-- <form action=""  class="help-search-form" method="get">
					...
					<div class="search-form-group row">	         	
						<div class="col-md-12">
							...
							<button type="submit" title="help-Search" class="search-btn search-btn-lewin"><i class="fa fa-search" aria-hidden="true"></i></button>
						</div>
					</div>
				</form> --}}
				<form action=""  class="help-search-form" method="get">
								...
								<div class="container mt-2">
									<div class="row">
															...
															<div class="modal-dialog">
																<div class="modal-content">      
																	...
																	<div class="modal-body body-bg">
																		...
																		<form method="post" action="{{ route('demo.cancel.return') }}" id="frm-{{ $row->id }}">
																			@csrf
										...
										<div class="col-md-6">
											<div class="step-btn-group">
												<div class="step-btn-content">
													<a class="btn-next back-tab" href="{{route('jaded.order-detail', $row->id) }}" data-id="first">View Return Information</a>
												</div>
											</div>
										</div>
									</div>
