	...
	<div class="container">
		<div class="header-navigation">
			<nav class="navbar navbar-expand-lg">
				...
				<span class="navbar-toggler-icon"><img src="https://returns.shipcycle.ecomglobalsystems.com/public/images/ic_menu.png" height="28"></span>
				</button>
				...
				<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							...
							<option value="as" {{ session()->get('locale') == 'as' ? 'selected' : '' }}>Assamese</option>
							<!-- <option value="asa" {{ session()->get('locale') == 'asa' ? 'selected' : '' }}>Asu</option> -->
							<option value="az" {{ session()->get('locale') == 'az' ? 'selected' : '' }}>Azerbaijani</option>
							<!-- <option value="bas" {{ session()->get('locale') == 'bas' ? 'selected' : '' }}>Basaa</option> -->
							...
							<!-- <option value="bez" {{ session()->get('locale') == 'bez' ? 'selected' : '' }}>Bena</option> -->
							<option value="bg" {{ session()->get('locale') == 'bg' ? 'selected' : '' }}>Bulgarian</option>
							...
							<!-- <option value="bo" {{ session()->get('locale') == 'bo' ? 'selected' : '' }}>Tibetan</option> -->
							...
							<!-- <option value="ce" {{ session()->get('locale') == 'ce' ? 'selected' : '' }}>Chechen</option> -->
							<!-- <option value="chr" {{ session()->get('locale') == 'chr' ? 'selected' : '' }}>Cherokee</option> -->
							...
							<!-- <option value="dav" {{ session()->get('locale') == 'dav' ?'selected' : '' }}>Taita</option> -->
							<option value="de" {{ session()->get('locale') == 'de' ? 'selected' : '' }}>German</option>
							<!-- <option value="dje" {{ session()->get('locale') == 'dje' ? 'selected' : '' }}>Zarma</option> -->
							<!-- <option value="dsb" {{ session()->get('locale') == 'dsb' ? 'selected' : '' }}>Lower Sorbian</option> -->
							<!-- <option value="dua" {{ session()->get('locale') == 'dua' ? 'selected' : '' }}>Duala</option> -->
							<!-- <option value="dyo" {{ session()->get('locale') == 'dyo' ? 'selected' : '' }}>Jola-Fonyi</option> -->
							<option value="dz" {{ session()->get('locale') == 'dz' ?'selected' : '' }}>Dzongkha</option>
							<!-- <option value="ebu" {{ session()->get('locale') == 'ebu' ? 'selected' : '' }}>Embu</option> -->
							...
							<!-- <option value="ewo" {{ session()->get('locale') == 'ewo' ? 'selected' : '' }}>Ewondo</option> -->
							<option value="fa" {{ session()->get('locale') == 'fa' ? 'selected' : '' }}>Persian</option>
							<option value="ff" {{ session()->get('locale') == 'ff' ? 'selected' : '' }}>Fulah</option>
							<option value="fi" {{ session()->get('locale') == 'fi' ? 'selected' : '' }}>Finnish</option>
						    <option value="fil" {{ session()->get('locale') == 'fil' ? 'selected' : '' }}>Filipino</option>
							<option value="fo" {{ session()->get('locale') == 'fo' ?'selected' : '' }}>Faroese</option>
							<option value="fr" {{ session()->get('locale') == 'fr' ? 'selected' : '' }}>France</option>
							<option value="fur" {{ session()->get('locale') == 'fur' ? 'selected' : '' }}>Friulian</option>
						    <option value="ga" {{ session()->get('locale') == 'ga' ? 'selected' : '' }}>Irish</option>
							<option value="gd" {{ session()->get('locale') == 'gd' ? 'selected' : '' }}>Scottish Gaelic</option>
						    <option value="gl" {{ session()->get('locale') == 'gl' ? 'selected' : '' }}>Galician</option>
							<option value="gu" {{ session()->get('locale') == 'gu' ? 'selected' : '' }}>Gujarati</option>
						    <!-- <option value="guz" {{ session()->get('locale') == 'guz' ? 'selected' : '' }}>Gusii</option> -->
							<!-- <option value="gv" {{ session()->get('locale') == 'gv' ? 'selected' : '' }}>Manx</option> -->
						    ...
						    <option value="hr" {{ session()->get('locale') == 'hr' ? 'selected' : '' }}>Croatian</option>
							<option value="zh" {{ session()->get('locale') == 'zh' ? 'selected' : '' }}>Chinese</option>
							<!-- <option value="hsb" {{ session()->get('locale') == 'hsb' ? 'selected' : '' }}>Upper Sorbian</option> -->
							...
							<option value="ii" {{ session()->get('locale') == 'ii' ? 'selected' : '' }}>Sichuan Yi</option>
						    <option value="in" {{ session()->get('locale') == 'in' ? 'selected' : '' }}>Indonesian</option>
							...
							<option value="iw" {{ session()->get('locale') == 'iw' ?'selected' : '' }}>Hebrew</option>
							<option value="ja" {{ session()->get('locale') == 'ja' ? 'selected' : '' }}>Japanese</option>
							<option value="jgo" {{ session()->get('locale') == 'jgo' ? 'selected' : '' }}>Ngomba</option>
							<option value="jmc" {{ session()->get('locale') == 'jmc' ? 'selected' : '' }}>Machame</option>
							<option value="ka" {{ session()->get('locale') == 'ka' ? 'selected' : '' }}>Georgian</option>
							<option value="kab" {{ session()->get('locale') == 'kab' ?'selected' : '' }}>Kabyle</option>
							<option value="kam" {{ session()->get('locale') == 'kam' ? 'selected' : '' }}>Kamba</option>
							<option value="kde" {{ session()->get('locale') == 'kde' ? 'selected' : '' }}>Makonde</option>
							<option value="kea" {{ session()->get('locale') == 'kea' ? 'selected' : '' }}>Kabuverdianu</option>
							<option value="khq" {{ session()->get('locale') == 'khq' ? 'selected' : '' }}>Koyra Chiini</option>
							<option value="ki" {{ session()->get('locale') == 'ki' ?'selected' : '' }}>Kikuyu</option>
				            <option value="kk" {{ session()->get('locale') == 'kk' ? 'selected' : '' }}>Kazakh</option>
							<option value="kkj" {{ session()->get('locale') == 'kkj' ? 'selected' : '' }}>Kako</option>
							<option value="kl" {{ session()->get('locale') == 'kl' ? 'selected' : '' }}>Kalaallisut</option>
							<option value="kln" {{ session()->get('locale') == 'kln' ? 'selected' : '' }}>Kalenjin</option>
							...
							<option value="kok" {{ session()->get('locale') == 'kok' ?'selected' : '' }}>Konkani</option>
							<option value="ks" {{ session()->get('locale') == 'ks' ?'selected' : '' }}>Kashmiri</option>
							<option value="ksb" {{ session()->get('locale') == 'ksb' ? 'selected' : '' }}>Shambala</option>
							<option value="ksf" {{ session()->get('locale') == 'ksf' ? 'selected' : '' }}>Bafia</option>
							<option value="ksh" {{ session()->get('locale') == 'ksh' ?'selected' : '' }}>Colognian</option>
							<option value="kw" {{ session()->get('locale') == 'kw' ? 'selected' : '' }}>Cornish</option>
							<option value="ky" {{ session()->get('locale') == 'ky' ?'selected' : '' }}>Kyrgyz</option>
							<option value="lag" {{ session()->get('locale') == 'lag' ? 'selected' : '' }}>Langi</option>
