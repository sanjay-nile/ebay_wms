<div class="rg-step-card">
	...
	<div class="side-titles show-web">
        <div class="title-text">
            <h3>{{ googleTranslate('Order Details') }} </h3>
        </div>
        <div class="title-text">
            <h3>{{ googleTranslate('Order Summary') }} </h3>
        </div>
        <div class="title-text">
            <h3>{{ googleTranslate('Order Address') }} </h3>
        </div>
        <div class="title-text">
            <h3>{{ googleTranslate('Carrier Selection') }} </h3>
        </div>
        <div class="title-text mb-0">
            <h3>{{googleTranslate('Return Request')}}</h3>
        </div>
    </div>
    <div class="side-titles show-mobile">
        <div class="title-text">
            <h3>{{ googleTranslate('Order Details') }} </h3>
        </div>
        <!-- <div class="title-text">
...
{{-- <div class="navbar-brand logo mt-5 mr-3">
    <img src="{{ asset('public/label/DPD_logo.png') }}" height="60">
</div>
<div class="navbar-brand logo mt-5 ml-2">
