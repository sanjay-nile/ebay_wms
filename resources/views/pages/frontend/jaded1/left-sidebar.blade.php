						          			...
						          			<div class="step-content-form">
						          				...
						          				<div class="step-form" id="customer-info">
						          					<div class="row">
							                  			...
							                  			<div class="col-md-12">
							                  				<div class="form-group">
							                  					<label class="">{{googleTranslate('Phone Number')}}</label>
							                  					<input type="text" class="form-control" name="customer_phone" id="customer_phone" placeholder="{{googleTranslate('Enter Phone Number')}}">
							                  					<span class="text-danger"></span>
							                  				</div>
							                  			</div>
							                  			<div class="col-md-5">
								...
								<div class="step-content-body">
									<div class="row">
										<div class="col-md-8">
											...
											<div class="step-content-form">
												<h3>Select available return option</h3>
      					              			...
      					              			<div class="carrier-list">
      					              				<div class="carrier-item">
      						              				...
      						              				<div class="carrier-table">
      						              					<h4>QR Code label – no printer needed</h4>
		      					              				<table class="table table-responsive">
		      					              					<thead>
		      					              						<tr>
		      					              							<th>Service</th>
		      					              							<th>Max Weight/Dimensions</th>
		      					              							<th>Device needed</th>
		      					              							<th>Price</th>
		      					              					...
		      					              					<tbody>
		      					              						<tr>
		      					              							...
		      					              							<td>
		      					              								<p class="">Max 15kg</p>
		      					              								<p>Max L64cm x H41cm X W38cm</p>
		      					              							</td>
		      					              							<td>
		      					              							<div class="carrier-table-icon">
						              										<img src="{{ asset('public/label/Printer-close.svg') }}">
						              									</div>
		      					              							</td>
		      					              							<td>0.00 GBP</td>
		      					              							<td>
		      					              							...
		      					              							<td>
		      					              								<div class="carrier-table-icon">
						              											<a href="https://returns.shipcycle.ecomglobalsystems.com/jaded/tracking"> <img src="{{ asset('public/label/location.svg') }}"></a>
						              										</div>
		      					              							</td>
		      					              							<td>
		      					              								<div class="PBradio1">
					      						              					<input id="carrierlabel2" type="radio" name="Postaltype" value="postal">
		      					              						...
		      					              						<tr>
		      					              							...
		      					              							<td>
		      					              								<div class="carrier-label-card">
		      					              									<div class="carrier-label-card-image">
		      					              										<img src="{{ asset('public/label/toyou-squarelogo.png') }}">
		      					              									</div>
		      					              									<div class="carrier-label-card-text">24/7 ToYou Lockers:<br> Drop off<br> No Printer Required <br> X-X Days</div>
		      					              								</div>
		      					              							</td>
		      					              							...
		      					              							<td>
		      					              								<div class="carrier-table-icon">
						              											<img src="{{ asset('public/label/location.svg') }}">
						              										</div>
		      					              							</td>

		      					              							<td>
		      					              								<div class="PBradio1">
					      						              					<input id="carrierlabel3" type="radio" name="Postaltype" value="postal">
		      					              						...
		      					              						<tr>
		      					              							...
		      					              							<td>
		      					              								<div class="carrier-label-card">
		      					              									...
		      					              									<div class="carrier-label-card-text">Royal Mail Drop off Location</div>
		      					              								</div>
		      					              							</td>
		      					              							
		      					              							<td>
		      					              								<p class="">Max 10kg</p>
		      					              								<p> Max L40cm x H50cm x W53cm</p>
		      					              							</td>
		      					              							<td>
		      					              							<div class="carrier-table-icon">
						              										<img src="{{ asset('public/label/Printer-check.svg') }}">
						              									</div>
		      					              							</td>
		      					              							<td>0.00 GBP</td>
		      					              							<td>
		      					              							...
		      					              							<td>
		      					              								<div class="carrier-table-icon">
						              											<a href="https://returns.shipcycle.ecomglobalsystems.com/jaded/tracking" target="_blank"target="_blank"> <img src="{{ asset('public/label/label/label/tracking.jpg') }}"></a>
						              										</div>
		      					              							</td>
		      					              							<td>
		      					              								<div class="PBradio1">
					      						              					<input id="carrierlabel1" type="radio" name="Postaltype" value="postal" checked="checked">
								...
								<div class="step-content-body">
									...
									<div class="step-content-form">
			              				...
			              				<div class="mt-2 return-detail">
			              					<p>{{googleTranslate('You can then either print your return label at home or take it to the selected carrier drop off point to print and send your shipment back to Jaded London.')}} </p>
			              					<p>{{googleTranslate('An email has also been sent to you from')}} <a href="mailto:jaded@ecomglobalsystems.com">jaded@ecomglobalsystems.com</a> {{googleTranslate('containing the shipping label and a list of the return carrier locations.')}}</p>
