...
<div class="row">
	<div class="col-md-3">
        @include('pages.frontend.demo.left-sidebar')
    </div>
											...
											<div class="missguided-tabs-info">
												<div class="missguided-right-content">													
								          			<div class="step-content-form">
							          					...
							          					<p style="margin-bottom: 1.1rem;">If you have multiple orders to return. create a separate return label for each ORDER. Non-refundable grooming products, and underwear/swimwear where the hygiene seal is removed are non-refundable. All of our face coverings are non-refundable. View our full <a href="https://demo-returns.reversegear.net/public/images/Ecom_Global_GDPR_Privacy_Notice_v_1.0.pdf" target="_blank"><b>return policy</b></a>.</p>
		  	  		    		...
		  	  		    		<div class="step-content-btn">
		  	  		    			<div class="row mob-btn-change">
		  	  		    				<div class="col-md-6">
		  	  		          			...
		  	  		          			<div class="col-md-6">
		  	  		    					<div class="step-btn-group text-right">
		  	  		    						<a class="btn-next-lewin" id="step2-valid" href="javascript:void(0)">Next</a>
		  	  		          				</div>
		  	  		          			</div>
		  	  		          		</div>
		  	  		    		</div>
								...
								<div class="step-content-body">
									...
									<div class="step-content-form">
			              				...
			              				<div class="mt-2 return-detail">
			              					<p>You can then either print your return label at home or take it to the selected carrier drop off point to print and send your shipment back to Demo Client. </p>
			              					<p>An email has also been sent to you from <a href="mailto:info@shipcycle.com">info@shipcycle.com</a> containing the shipping label and a list of the return carrier locations.</p>
