						              		...
						              		<div class="row">
						                          			    	...
						                          			    	<div class="modal-dialog">
						                          			      		<div class="modal-content">      
						                          				        	...
						                          				        	<div class="modal-body body-bg">
						                          					         	...
						                          					         	<form method="post" action="{{ route('motel-rocks.cancel.return') }}" id="frm-{{ $row->id }}">
						                          					         		@csrf
						                        ...
						                        @endif
						                     	<div class="col-md-6">
						                    		<div class="step-btn-group">
						                      			<div class="step-btn-content">
						                        			<a class="btn-next back-tab" href="{{route('motel-rocks.order-detail', $row->id) }}" data-id="first">View Return Information</a>
						                      			</div>
						                    		</div>
						                  		</div>
						                  	</div>
