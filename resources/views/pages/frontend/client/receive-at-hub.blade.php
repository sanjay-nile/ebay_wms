@include('pages.frontend.client.breadcrumb', ['title' => 'Received at Hub Orders'])
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-2">
                            ...
                            <a href="{{ route('client.reverse-logistic-list') }}" class="btn-refresh reset"><i class="la la-refresh"></i> Reset</a>
                        </div>
                    </div>
                </div>
            </div>
