                        ...
                        <div class="col-md-3">
                            <div class="input-group mb-2">
                                <select name="order_type" class="form-control">
                                    ...
                                    <option value="inscan" {{ (app('request')->input('order_type')=='inscan')?"selected":'' }}>First InScan Returns</option>
                                ...
                                <tbody>
                                    ...
                                    @forelse($lists as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->rg_reference_number }}</td>
                                            <td>{{ $meta['_customer_name'] }}</td>
                                            <td>{{ $meta['_customer_email'] }}</td>
                                            <td>{{ date('d/m/Y h:i:s a',strtotime($row->created_at)) }}</td>
                                            <td>{{ $meta['_customer_country'] }}</td>
                                            <td>{{ $row->shippingPolicy->carrier->name ?? $meta['_carrier_name'] }}</td>
                                            <td>{{ $row->shippingPolicy->shippingType->name ?? $meta['_shipment_name'] }}</td>
                                            <td>{{ $track_id }}</td>
