                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <select name="return_reson" class="form-control">
                                        ...
                                        @forelse(olive_reason_of_return() as $k => $v)
            ...
            <div class="card-content collapse show">
                <div class="card-body booking-info-box card-dashboard table-responsive">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        {{-- <button type="button" class="btn btn-sm btn-danger pull-right mb-1" id="excel-btn">Export To Excel</button> --}}
                        ...
                        <div class="tab-pane fade" id="pills-item" role="tabpanel" aria-labelledby="pills-item-tab">
                            <div class="text-right px-1 mt-2">
                                <button type="button" id="process-btn" class="btn btn-danger btn-sm">Process</button>
                            </div>
                            <form action="{{ route('client.refund.order.status') }}" method="post" id="refund-status">
                                @csrf
                                <table id="client_user_list" class="table table-striped table-bordered nowrap avn-defaults table-hover table-sm">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($lists as $row)
                                            @forelse($row->packages as $pakage)
                                                ...
                                                <tr>
                                                    <td>
                                                        @if($row->status == 'Success' && $row->process_status == 'processed' && $pakage->refund_status == 'No')
                                                            <input name="pkg_ids[]" value="{{ $pakage->id }}" type="checkbox" />
                                                        @endif
                                                    </td>
                                                    <td>{{ $i++ }}</td>
                                                    <td>
