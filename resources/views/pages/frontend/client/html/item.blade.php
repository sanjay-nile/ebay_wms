			...
			<div class="row">
				...
				<div class="col-md-2 collapse">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="length[]" placeholder="Length" value="{{ ($item['depth'] > 0) ? $item['depth'] : 1 }}">
					</div>
				</div>
				<div class="col-md-2 collapse">
					<div class="form-group">
						<label for="">Width</label>
						<input type="text" class="form-control" name="width[]" placeholder="Width" value="{{ ($item['width'] > 0) ? $item['width'] : 1 }}">
					</div>
				</div>
				<div class="col-md-2 collapse">
					<div class="form-group">
						<label for="">Height</label>
						<input type="text" class="form-control" name="height[]" placeholder="Height" value="{{ ($item['height'] > 0) ? $item['height'] : 1 }}">
					</div>
				</div>
				<div class="col-md-2 collapse">
					<div class="form-group">
				...
				<div class="col-md-2 collapse">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="weight[]" placeholder="Weight" value="{{ ($item['weight'] > 0) ? $item['weight']/1000 : 1 }}">
					</div>
				</div>
				<div class="col-md-7">
					<div class="form-group">
