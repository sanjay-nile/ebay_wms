@include('pages.frontend.client.breadcrumb', ['title' => 'Return Order Detail'])
        ...
        <div class="booking-info-box">
            <div class="card-content">
                <div class="">
                    ...
                    @endphp
                    <h4 class="card-title">
                        <a href="{{ route('client.return.orders') }}" class="btn btn-back"><i class="la la-arrow-left"></i> Back</a>
                                                ...
                                                @forelse($waybill->packages as $package)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @elseif ($waybill->meta->_rtn_total)
                                                                {{ $waybill->meta->_rtn_total }}
                                                            @else
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content track-content">      
                                    ...
                                    <div class="modal-body body-bg">
                                        ...
                                        <form method="post" action="{{ route('client.cancel.return') }}" id="frm-{{ $waybill->id }}">
                                            @csrf
