...
<div class="row">
	<div class="col-md-3">
        @include('pages.frontend.tmlewin.left-sidebar')
    </div>

	<div class="col-md-9">
		<form method="post" id="create-waybill" action="{{ route('tmlewin.order.create') }}" class="myform">
											...
											<div class="missguided-tabs-info">
												<div class="missguided-right-content">													
								          			<div class="step-content-form">
								          				...
								          				<ul>
								          					<li>Please note T.M.Lewin are unable to accept underwear or shoes back for hygiene reasons.  Shoes should only be tried indoors and do NOT show any signs of wear. </li>
								          					<li>Returned items must be in resalable condition. </li>
								          					<li>They must not be worn and must still have the tags attached to the items. </li>
								          					<li>They need be returned to T.M.Lewin within 90 days upon receipt of delivery. </li>
								          				</ul>
								          				
								          				<p class="sm-text">For more information, please visit T.M.Lewin’s  full <a target="_blank" href="https://www.tmlewin.co.uk/returns">return policy</a>, <a target="_blank" href=" https://help.tmlewin.co.uk/hc/en-gb/categories/201031505-Returns-Refunds">FAQ </a> or contact the <a target="_blank" href=" https://help.tmlewin.co.uk/hc/en-gb/requests/new?_ga=2.221214171.273698679.1638802976-949253558.1638193722">Customer Service</a> team.</p>
								...
								<div class="step-content-body">
									...
									<div class="step-content-form">
										<div class="step-note-info">
											...
											Unfortunately, we may experience some delay in processing refunds at this time, but rest assured we are doing our best to process within the usual time frame of 10-14 days
										</div>
			              				<h3>YOUR RETURN HAS NOW BEEN COMPLETED – THANK YOU</h3>
			              				<div class="mt-2 return-detail">
			              					<p>You can either print your return label at home or take it to the selected carrier drop off point to print and send your shipment back to T.M.Lewin. </p>
