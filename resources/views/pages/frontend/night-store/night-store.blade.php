	...
	$(document).ready(function(){
		...
		$('body').on('click','#fetch-product',function(){
		    ...
		    if(cl_id != ''){
		    	if(ordr_id != '' && mail_id != ''){
		    	    $.ajax({
		    	        url:"{{ route('night-store.fetch.order') }}",
		    	        type:"GET",
...
<div class="row">
	<div class="col-md-12">
        @include('pages.frontend.night-store.left-sidebar')
		<div class="rg-step-content-1">
			<form method="post" id="create-waybill" action="{{ route('night-store.order.create') }}" class="myform">
				...
				<div class="rg-step-content-body">
					<div class="step-content tab-content">
						...
						<div class="tab-pane active" id="tab1">
							<div class="row">
								<div class="col-md-8">
									<div class="rg-step-card-info">
										<span class="bg-shape"></span>
										<div class="step-content-form-box step-scoll-box">
												...
												<div class="missguided-tabs-info">
													<div class="missguided-right-content">													
									          			<div class="step-content-form">
									          				...
									          				<p>If you have multiple orders to return, create a separate return label for each <b>ORDER.</b></p>
									          				<ul>
									          					<li>Grooming products, underwear and swimwear with the hygiene seal removed are non-refundable. All face coverings are also non-refundable.</li>
									          					<li>In order to make a successful return, the garment must be in an unworn condition and remain in its original packaging with tags included.</li>
									          					<li>Please allow up to 10 working days for us to receive your items.</li>
									          					<li>View our full <a href="https://www.night-store.co.uk/pages/returns" target="_blank"><b>return policy</b></a> for further information or simply fill in the <a target="_blank" href="https://www.night-store.co.uk/pages/contact-us">contact form</a> from Night Store main page.</li>
									          				</ul>
						...
						<div class="tab-pane" id="tab3">
							<div class="row">
								<div class="col-md-8">
					  		    ...
					  		    <div class="col-md-4">
				  		    		<div class="order-item rtn_sumry">
									...
									<div class="rg-step-card-info">
										...
										<div class="step-content-form-box step-scoll-box">
											<div class="step-content-body">
												...
												<div class="step-content-form">
						              				<h3>Thank you for creating your return.</h3>
						              				<div class="mt-2 return-detail">
			                                            <p>Please print the label and attach this to your parcel</p>
						              					<p>We’ve sent an email from <a href="mailto:info@reversegear.net">info@reversegear.net</a> containing your label. Please check your junk or spam folder</p>
