               ...
               <div class="card mb-0">
                  ...
                  <div id="collapse-1" class="card-body collapse" data-parent="#accordion" >
                     <div class="faq-accordion-body">
                        ...
                        <p>
                           After this point, the retailer will process your return and arrange for your refund in accordance with their specific returns policy. <a href="https://www.missguided.eu/help#ui-id-1" target="_blank" rel="noopener">View our return policy</a>.
                        </p>
                     </div>
                  </div>
                  ...
                  <div id="collapse-2" class="card-body collapse" data-parent="#accordion" >
                     <div class="faq-accordion-body">
                        <p>
                           If you are having trouble registering a return, contact us with your order number and screenshots of the error message you are seeing.
                        </p>
                        <!--   <p>
                  ...
                  <div id="collapse-8" class="card-body collapse" data-parent="#accordion" >
                     <div class="faq-accordion-body">
                        ...
                        <p>
                           After you <a href="{{ route('missguided.home') }}" target="_blank" rel="noopener">create a return
                        ...
                        <p>
                           To download a return label that you have already generated, go to <a href="{{ route('missguided.tracking') }}" target="_blank" rel="noopener">Track My Return</a> and enter your order details. Before downloading your label, check your browser settings to make sure that ‘download PDFs’ is set to ON.
                        </p>
                  ...
                  <div id="collapse-5" class="card-body collapse" data-parent="#accordion" >
                     <div class="faq-accordion-body">
                        <p>
                           To cancel your return, go to <a href="{{ route('missguided.tracking') }}" target="_blank">track my return </a> and find your order using your tracking number or order number and email address. Scroll to the relevant return and select 'cancel'.
                        </p>
                        <p>
                        ...
                        <p>
                           ...
                           <a href="{{ route('missguided.home') }}" target="_blank">create a return</a> process.
                        </p>
                        <p>
                     </div>
                  </div>
                  ...
                  <div id="collapse-6" class="card-body collapse" data-parent="#accordion" >
                     <div class="faq-accordion-body">
                        <p>
                           To track your return, go to <a href="{{ route('missguided.tracking') }}" target="_blank">track my return </a> and enter your tracking ID (this can be found on your return confirmation email.) 
                        </p>
                        <p>
                  ...
                  <div id="collapse-7" class="card-body collapse" data-parent="#accordion" >
                     <div class="faq-accordion-body">
                        <p>
                           If your return doesn't have any tracking updates within 24 hours of dropping it off - get in touch on our help page with your order number/ tracking number  to let us know.
                        </p>
                     </div>
                  </div>
               </div>
