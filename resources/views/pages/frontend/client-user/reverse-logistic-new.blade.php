@include('pages.frontend.client-user.breadcrumb', ['title' => 'New Return Orders'])
                            ...
                            @forelse($lists as $row)
                                @forelse($row->packages as $pakage)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-view btn-success" href="{{ route('client-user.waybill.detail',$row) }}" title="View">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
