@include('pages.frontend.client-user.breadcrumb', ['title' => 'All Returns'])
                        ...
                        <div class="col-md-3">
                            <div class="input-group mb-2">
                                <select name="order_type" class="form-control">
                                    ...
                                    <option value="new">Failed Label</option>
	            ...
	            <div class="card-body">
	                <div class="row">
	                    ...
	                    <div class="col-md-6 mt-2">
	                        ...
	                        <a href="{{ route('client-user.return.orders') }}" class="btn-refresh reset"><i class="la la-refresh"></i> Reset</a>
	                    </div>
	                </div>
	            </div>
	        </div>
                ...
                <div class="card-body booking-info-box card-dashboard table-responsive">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-order" role="tabpanel" aria-labelledby="pills-order-tab">
                            ...
                            <table id="client_user_list" class="table table-striped table-hover nowrap table-sm">
                                <thead>
                                    <tr>
                                        <th>S no.</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($row->status == 'Pending')                                                    
                                                    <a class="btn btn-view btn-success" href="{{ route('new.order.detail',$row) }}" title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                @else
                                                    <a class="btn btn-view btn-success" href="{{ route('order.detail',$row) }}" title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                @endif
                                            </td>
