...
<form method="post" id="create-waybill" action="{{route('other.clientuser.ordercreate')}}" class="myform">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group mt-4">
                        <label>&nbsp;</label>
                        <button type="button" class="btn btn-red" style="margin-top: 2px;" id="clientuser-fetch-order">
