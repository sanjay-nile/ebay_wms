<form method="post" id="create-waybill" action="{{ route('client-user.missguided.order.store') }}" enctype="multipart/form-data" autocomplete="off">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group mt-4">
                        <label>&nbsp;</label>
                        <button type="button" class="btn btn-red" style="margin-top: 2px;" id="missguided-fetch-order">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="customer_country" class="form-control" value="">
