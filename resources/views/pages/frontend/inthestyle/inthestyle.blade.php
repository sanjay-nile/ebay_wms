	...
	$(document).ready(function(){
		...
		$('body').on('click','#fetch-product',function(){
		    ...
		    if(cl_id != ''){
		    	if(ordr_id != '' && mail_id != ''){
		    	    $.ajax({
		    	        url:"{{ route('inthestyle.fetch.order') }}",
		    	        type:"GET",
...
<div class="row">
	<div class="col-md-3">
        @include('pages.frontend.inthestyle.left-sidebar')
    </div>

	<div class="col-md-9">
		<form method="post" id="create-waybill" action="{{ route('inthestyle.order.create') }}" class="myform">
										...
										<div class="col-md-8">
											...
											<div class="missguided-tabs-info">
												<div class="missguided-right-content">													
								          			<div class="step-content-form">
								          				<h3>Your order contains <span id="itm-qty">X</span> items - please select the items you would like to return.</h3>
								          				<p>If you have multiple order numbers to return, please create a separate return label for each <b>ORDER</b> or your refund could be delayed.</p>
								          				<!-- <p>If you have multiple order numbers to return, please create a separate return label for each <b>ORDER</b>, otherwise your refund could be delayed.</p> -->
								          				<p class="bl-text"><b>ATTENTION!</b></p>
								          				<ul>
								          					<li>Please note In The Style accepts only items in the original packaging with tags attached.</li>
								          					<li>They must not be worn have marks or make up on. If you receive your item in this state, please <a target="_blank" href="https://www.inthestyle.com/contacts">contact customer service</a> immediately upon receipt of delivery. </li>
								          					<li>Lingerie with removed hygiene seal will be rejected and shoes should only be tried indoors and do NOT show any signs of wear. </li>
								          					<li>Products must be logged on In The Style return portal within 14 days from receiving your order.</li>
								          				</ul>
								          				
								          				<p class="sm-text">For more information, please visit In The Style <a target="_blank" href="https://www.inthestyle.com/returns">Return Help page</a>, <a target="_blank" href="https://www.inthestyle.com/customer-service-hub">Customer Service hub</a>, fill in <a target="_blank" href="https://www.inthestyle.com/contacts">contact form</a> or simply start a chat with Advisor from the In The Style main page.</p>
								          				<!-- <br> -->
								...
								<div class="step-content-body">
									...
									<div class="step-content-form">
										<div class="COVID-note">
											<p>Due to the COVID-19 pandemic and warehouse restrictions, please allow 28 days for In The Style to process your refund and have this returned back into your original method of payment.</p>
											<p> Please note store credit will be issued on orders outside of the returns timescales.</p>
										</div>
			              				<h3 class="text-uppercase">YOUR RETURN HAS NOW BEEN COMPLETED – THANK YOU</h3>
			              				<div class="mt-2 return-detail">
			              					<p>You can either print your return label at home or take it to the selected carrier drop off point to print and send your shipment back to In The Style. </p>
