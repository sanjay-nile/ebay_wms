        ...
        <div class="step-content-form-box">
			<div class="step-content-body">
				<div class="tracking-wrapper">
				    ...
				    @endif
				   	<div class="tracking-search-container-lewin mb-0">
				      	...
				      	<form action=""  class="help-search-form" method="get">
				         	...
				         	<div class="search-form-group row">
					        	...
					        	<div class="col-md-6 mob-mt">
						            ...
						            <button type="submit" title="help-Search" class="search-btn-lewin"><i class="fa fa-search" aria-hidden="true"></i></button>
						        </div>
				         	</div>
				      	</form>
				      	<form action=""  class="help-search-form" method="get">
						              		...
						              		<div class="row">
						                          			    	...
						                          			    	<div class="modal-dialog">
						                          			      		<div class="modal-content">      
						                          				        	...
						                          				        	<div class="modal-body body-bg">
						                          					         	...
						                          					         	<form method="post" action="{{ route('inthestyle.cancel.return') }}" id="frm-{{ $row->id }}">
						                          					         		@csrf
						                        ...
						                        @endif
						                     	<div class="col-md-6">
						                    		<div class="step-btn-group">
						                      			<div class="step-btn-content">
						                        			<a class="btn-next back-tab" href="{{route('inthestyle.order-detail', $row->id) }}" data-id="first">View Return Information</a>
						                      			</div>
						                    		</div>
						                  		</div>
						                  	</div>
