	...
	$(document).ready(function(){
		...
		$('body').on('click','#fetch-product',function(){
		    ...
		    if(cl_id != ''){
		    	if(ordr_id != '' && mail_id != ''){
		    	    $.ajax({
		    	        url:"{{ route('auswooli.fetch.orders') }}",
		    	        type:"GET",
...
<div class="row">
	<div class="col-md-3">
        @include('pages.frontend.auswooli.left-sidebar')
    </div>

	<div class="col-md-9">
		<form method="post" id="create-waybill" action="{{ route('demo.order.create') }}" class="myform">
										...
										<div class="col-md-8">
											...
											<div class="missguided-tabs-info">
												<div class="missguided-right-content">
								          			<div class="step-content-form">
								          				<h3>Please select the items which are in your package</h3>

								          				<p>To be eligible for refund your item must be:</p>
								          				<ul class="step-content-refund-list">
								          					<li>Brand new</li>
								          					<li>Unworn</li>
								          					<li>Free of scuff marks</li>
								          					<li>Free from holes</li>
								          					<li>Free from stains</li>
								          					<li>Stitching not damaged</li>
								          					<li>Colouration of product is as new</li>
								          					<li>Boots/Shoes/Moccassins soles clean with no marks</li>
								          					<li>There has been no alteration to the product</li>
								          					<li>The product has not been worn extensively/misused or under extreme conditions</li>
								          				</ul>
								          				<p>All tags, labelling, packaging and dust bags must also be returned with the product including the branded box which should be unaltered in any way e.g.: No shipping forms attached, tape or marks on the box.</p>
								          				<p><b>If a refund is processed it will be in the following way:</b></p>
								          				<p>Credit Card or PayPal transaction - Your refund amount will be credited to the same account in which you used to make your initial purchase</p>
								          				<p>Part Credit Card/Part Voucher transaction - The amount paid via Credit Card will be credited to the account in which you made your initial transaction and a new voucher will be reissued for the remaining balance.</p>
							          					
							          					<p> For more information view our <a href="https://www.auswooli.com.au/policies/refund-policy" target="_blank"><b>return terms</b></a>.</p>
								          				<div id="item-summary"></div>

								          				<div class="check-text-info">
								          					<p class="cnf-text"><b>You have chosen <span id="rtn-items">0</span> <span id="chn-txt">item</span> to return, please check the box below to confirm your selection. I would like to submit my return.</b></p>
						...
						<div class="tab-pane" id="tab5">
							<div class="step-content-form-box">
								<div class="step-content-body">
									...
									<div class="step-content-form">
			              				<h3>All done – Thank you for creating your return.</h3>
			              				<div class="mt-2 return-detail">
			              					<p>You can then either print your return label at home or take it to the selected carrier drop off point to print and send your shipment back to Jaded London. </p>
			              					<p>An email has also been sent to you from <a href="mailto:jaded@ecomglobalsystems.com">jaded@ecomglobalsystems.com</a> containing the shipping label and a list of the return carrier locations.</p>
