					...
					<tbody>
						<tr>
							<td align="center" style="padding:10px;">
								<p>Email: <a href="mailto:{{Config::get('constants.defaultEmail')}}" style="color:#ffffff; text-decoration:none;">{{Config::get('constants.defaultEmail')}}</a> &nbsp; | &nbsp; Phone: <a href="tel:{{Config::get('constants.defaultPhone')}}" style="color:#ffffff; text-decoration:none;">{{Config::get('constants.defaultPhone')}}</a></p>
